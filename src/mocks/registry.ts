...
export interface MockMap {
  ...
  "amazon.profit": ReturnType<AmazonMocks["profitMock"]>;
  ...
  "system.storage": ReturnType<BriefingMocks["storageMock"]>;
  ...
  "system.security": ReturnType<BriefingMocks["securityMock"]>;
  "system.automation": ReturnType<BriefingMocks["automationMock"]>;
  "system.version": ReturnType<BriefingMocks["versionMock"]>;
  "system.settings": ReturnType<BriefingMocks["settingsMock"]>;
...
export async function loadMock<K extends MockKey>(key: K): Promise<MockMap[K] | null> {
  ...
  switch (key) {
    ...
    case "amazon.profit":
      return (await import("./amazon")).profitMock() as MockMap[K];
    ...
    case "system.storage":
      return (await import("./briefing")).storageMock() as MockMap[K];
    case "memory.executive":
      return (await import("./briefing")).executiveMemoryMock() as MockMap[K];
    case "system.ai":
    ...
    case "system.security":
      return (await import("./briefing")).securityMock() as MockMap[K];
    case "system.automation":
      return (await import("./briefing")).automationMock() as MockMap[K];
    case "system.version":
      return (await import("./briefing")).versionMock() as MockMap[K];
    case "system.settings":
      return (await import("./briefing")).settingsMock() as MockMap[K];
    case "briefing.kpis":
