...
Bu repodaki kararlar `UI-ADR-001…146` serisindedir.
ODIN'in kendi serisi `ADR-0001…` — **karıştırma.**

Yeni bir mimari karar alırsan `08-decision-log.md`'ye **`UI-ADR-147`'den**
...
| **S13 Kurumsal Ön Yüz Mimarisi** | ⚠️ **dalda** — `feature/s13-frontend-architecture`, UI-ADR-130…146. **lokal, push/merge YOK, sahip onayı YOK.** main (S14) dala merge edildi. ➜ **`19-s13-devir.md` oku** |
