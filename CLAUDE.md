...
Bu repodaki kararlar `UI-ADR-001…144` serisindedir.
ODIN'in kendi serisi `ADR-0001…` — **karıştırma.**

Yeni bir mimari karar alırsan `08-decision-log.md`'ye **`UI-ADR-145`'ten**
...
| **S13 Kurumsal Ön Yüz Mimarisi** | ⚠️ **dalda** — `feature/s13-frontend-architecture`, UI-ADR-130…144. **lokal, push/merge YOK, sahip onayı YOK.** main (S14) dala merge edildi. ➜ **`19-s13-devir.md` oku** |
